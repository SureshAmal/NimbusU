...
export default function AdminAnnouncementsPage() {
  ...
  const [contextMenuAnnouncement, setContextMenuAnnouncement] =
  ...
  const filteredItems = useMemo(() => {
    ...
    if (priorityFilter === "normal")
      result = result.filter((a) => !a.is_urgent);
    return result;
  ...
  return (
    <div className="space-y-0">
      <ContextMenu
        onOpenChange={(open) => {
          if (!open) setTimeout(() => setContextMenuAnnouncement(null), 200);
        }}
      >
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="start" className="w-32">
                            <DropdownMenuItem
                              onClick={() => setPriorityFilter("all")}
                              className={
                                priorityFilter === "all" ? "font-semibold" : ""
                              }
                            >
                              All
                            </DropdownMenuItem>
                    ...
                    {filteredItems.length === 0 ? (
                      ...
                      paginatedItems.map((a) => (
                        <Table.Row
                          key={a.id}
                          id={a.id}
                          onContextMenu={() => setContextMenuAnnouncement(a)}
                        >
        ...
        {contextMenuAnnouncement && (
          <ContextMenuContent className="w-48">
            ...
            <ContextMenuSeparator />
            <ContextMenuItem
              onClick={() => handleDelete(contextMenuAnnouncement.id)}
