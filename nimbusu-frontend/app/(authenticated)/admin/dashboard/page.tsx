...
import { Users, Building2, GraduationCap, Bell, FileText, BarChart3 } from "lucide-react";
                ...
                <Card style={{ boxShadow: "var(--shadow-sm)", borderRadius: "var(--radius-lg)" }}>
                    ...
                    <CardContent>
                        <p className="text-sm text-muted-foreground">
                            Activity feed will appear here once the system is populated with data.
                        </p>
                    </CardContent>
                </Card>
                <Card style={{ boxShadow: "var(--shadow-sm)", borderRadius: "var(--radius-lg)" }}>
                    ...
                    <CardContent className="space-y-2">
                        <p className="text-sm text-muted-foreground">
                            Use the sidebar to navigate to user management, academics, timetable, and more.
                        </p>
                    </CardContent>
                </Card>
            </div>
